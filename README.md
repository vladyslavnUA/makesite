...
[![Go Report Card](https://goreportcard.com/badge/github.com/YOUR_USERNAME/YOUR_REPONAME)](https://goreportcard.com/report/github.com/vladyslavnUA/makesite)
...
- [X] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [X] **_FILL IN THE BLANK_**: `I will use the Gommon Color library. The documentation is located at https://github.com/labstack/gommon/. My goal is to use it to add color to the GUI.`
- [X] **Add, commit, and push to GitHub**.
